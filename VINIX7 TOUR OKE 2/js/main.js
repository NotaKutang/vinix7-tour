...
async function loadPaketCards() {
    ...
    try {
        ...
        console.log('🔀 Loading packages via Hybrid Storage...');
        ...
        paketGrid.innerHTML = localPaket.map(p => createPaketCard(p)).join('');
    }
}
